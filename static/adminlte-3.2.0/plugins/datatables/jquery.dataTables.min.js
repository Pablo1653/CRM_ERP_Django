...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Proximo",sPrevious:"Previo"},sEmptyTable:"No hay info disponible",sInfo:"Mostrando _START_ to _END_ of _TOTAL_ registros",sInfoEmpty:"Mostrando 0 to 0 of 0 registros",sInfoFiltered:"(filtered from _MAX_ total entries)",
